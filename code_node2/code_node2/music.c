...
void wave_frequency(uint32_t frequency)
{
	...
	else
	{
		...
		#elif N==8
		TCCR3B = (TCCR3B & 0b11111000) | 0b010; // F_CPU/8
		#elif N==64
		TCCR3B = (TCCR3B & 0b11111000) | 0b011; // F_CPU/64
		#elif N==256
		TCCR3B = (TCCR3B & 0b11111000) | 0b100; // F_CPU/256
		#elif N==1024
		TCCR3B = (TCCR3B & 0b11111000) | 0b101; // F_CPU/1024
		#else
